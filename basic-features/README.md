# Demo der grundlegenden ES6+ Features
...
- Verständnis für moderne JavaScript-Syntax entwickeln
- Unterschiede zwischen ES5 und ES6+ erkennen
- Mehrwert von ES6+ Features praktisch nachvollziehen
- Live-Refactoring erleben

---

## Behandelte ES6+ Konzepte
...
3. `demo.html` im Browser öffnen
   (oder mit VS Code + Live Server starten)

Keine Installation oder zusätzliche Tools erforderlich.

---

## Ablauf in der Präsentation
